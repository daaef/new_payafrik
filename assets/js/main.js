...
const walletSidebarLinks = document.querySelectorAll(
...
function resetWalletModal() {
  document.querySelectorAll('.wallet--modals>div').forEach(function (modal) {
    console.log('removing class from modal', modal)
    modal.classList.remove('wallet-active')
  })
}
...
walletBtns.forEach(function (btn) {
  btn.addEventListener('click', function () {
    ...
    document
      ...
      .classList.add('wallet-active')
  })
}, 'myThisArg')

modalClose.forEach(function (modalLink) {
