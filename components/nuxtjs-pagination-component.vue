<template>
  <nav id="pagination">
    <ul v-if="$store.state.totalPageCount" class="page-numbers">
      <span v-if="num != null">
        <li
    ...
    <ul v-if="this.$store.state.totalPageCount != 1" class="page-guides">
      <li>
        <nuxt-link
      ...
      <li>
        <nuxt-link
          v-if="
            this.nextpage != null &&
            $route.query.page != $store.state.totalPageCount
          "
      ...
      <li>
        <nuxt-link
          v-if="$route.query.page != $store.state.totalPageCount"
          :to="{ path: '/', query: { page: $store.state.totalPageCount } }"
          >最後</nuxt-link
        >
        <span v-else>最後</span>
      </li>
