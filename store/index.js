...
export const mutations = {
  ...
  setWithdraw(state) {
    state.withdrawActive = !state.withdrawActive
  },
  setTransferToken(state) {
    state.transferTokenActive = !state.transferTokenActive
  },
...
export const getters = {
  ...
  chatBoxClosed(state) {
    return state.chatBoxClosed
  },
  tokenModalActive(state) {
    return state.tokenModalActive
  },
  canvasClass(state) {
    return state.canvasClass
  },
  activeWalletModal(state) {
    return state.activeWalletModal
  },
  ...
  buyTokenActive(state) {
    return state.buyTokenActive
  },
  withdrawActive(state) {
    return state.withdrawActive
  },
  transferTokenActive(state) {
    return state.transferTokenActive
  },
